...
public class NIOServer {
    ...
    /**
     * @Description: 处理读取客户端发来的信息的 事件
     * @date: 11:58 2018-10-19
     * @param: key 读的事件
     * @return: void
     */
    private void read(SelectionKey key) throws IOException {
        // 服务端可读取的消息：得到事件发生的Socket通道
